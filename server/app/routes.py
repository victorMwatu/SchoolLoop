...
from app.resources import SignupResource, LoginResource, MessageResource, SendMessageResource, MarkAsReadResource, ConversationMessagesResource, UsersResource
